...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler({SameEmailException.class})
    @ResponseStatus(HttpStatus.CONFLICT)
    public ErrorResponse handleSameEmailError(final SameEmailException exception) {
        return new ErrorResponse("Ошибка: одинаковые имейлы", exception.getMessage());
    }
